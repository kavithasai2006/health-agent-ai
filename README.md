If your Healthcare AI Agent runs locally at **[http://127.0.0.1:5000](http://127.0.0.1:5000)**, you can mention it in the README as the local application URL.
...
> ⚠️ Disclaimer: This application is for educational purposes only and should not be considered professional medical advice.
